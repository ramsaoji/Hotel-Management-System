		...
		<article>
			...
			<table >
					<tr> 
						...
						<td>Aadhar No. : -  <?php echo $aadhar; ?> </td>
					</tr>
					</tr>
			...
			<table class="inventory">
				...
				<tbody>
					...
					<tr></tr>
					<tr>
						<td><span >No. of People</span></td>
						<td><span ><?php echo $Nopeople; ?></span></td>
						<!-- <td><span ><?php echo $nodays; ?> </span></td> -->
						
					</tr>
					<tr>
						<td><span >Extra Persons Name.</span></td>
						<td><span ><?php echo $Extperson; ?></span></td>
						<!-- <td><span ><?php echo $nodays; ?> </span></td> -->
					...
					<tr>
						<td><span >Staying Days</span></td>
						<td><span ><?php echo $nodays; ?></span></td>
						<!-- <td><span ><?php echo $nodays; ?></span></td> -->
						
					</tr>
					<tr>
						<td><span >Arrival From</span></td>
						<td><span ><?php echo $arrival; ?></span></td>
						<!-- <td><span ><?php echo $nodays; ?></span></td> -->
						
					</tr>
					<tr>
						<td><span >Going Where</span></td>
						<td><span ><?php echo $going; ?></span></td>
						<!-- <td><span ><?php echo $nodays; ?></span></td> -->
						
					</tr>
					<tr>
						<td><span >Advance to Return</span></td>
						<td><span ><?php echo $advance; ?></span></td>
						<!-- <td><span ><?php echo $nodays; ?></span></td> -->
