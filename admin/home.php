        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="home.php"><i class="fas fa-tachometer-alt"></i></i> Status</a>
                    </li>
                    <li>
                                    ...
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
											...
											<button class="btn btn-default" type="button">
												 Pending Bookings  <span class="badge"><?php echo $c ; ?></span>
											</button>
											</a>
                                        </h4>
                                    </div>
                                    ...
                                    <div id="collapseOne" class="panel-collapse collapse" style="height: 0px;">
										...
										{		
											...
											echo"<div class='col-md-3 col-sm-12 col-xs-12'>
                                                    ...
                                                    <a href=update.php?uid=".$fid ."><button type='submit'  class='btn btn-primary btn'>
                                                    Update
                                                    </button></a><br>
															".$mrow['TRoom']."
														</div>
                                ...
                                <table class="table">
									...
									{	
											...
											echo"<tr>
												...
												<th>".$crow['email']." </th>
												<th>".$crow['cdate']." </th>
												<th><a href='messages.php' class='btn btn-primary'>Action</a></th>
												</tr>";
