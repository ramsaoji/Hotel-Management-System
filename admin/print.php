...
<html>
	<head>
		<meta charset="utf-8">
		<title>Invoice Ramkrishna</title>
...
@page { margin: 0; }
	...
	?>
		...
		<header>
			<h1>Invoice</h1>
			<address >
				<p>RAMKRISHNA LODGE,</p>
				<p>D.P Road,<br>Near Bustand,<br>Chikhli.</p>
				<p>(+91)9876543210</p>
			</address>
		...
		<article>
			...
			<table class="meta">
				...
				<tr>
					<th><span >Cin Date</span></th>
					<td><span ><?php echo $cin; ?> </span></td>
				</tr>
				<tr>
					<th><span >Cout Date</span></th>
					<td><span ><?php echo $cout; ?> </span></td>
				</tr>
				<tr>
					<th><span >Room No.</span></th>
					<td><span ><?php echo $roomno; ?> </span></td>
				</tr>
			...
			<table class="inventory">
				...
				<tbody>
					<tr>
						...
						<td><span data-prefix>₹</span><span><?php echo ($type_of_room*$days); ?></span></td>
					</tr>
					<tr>
						...
						<!-- <td><span ><?php echo $nroom;?> </span></td> -->
						<td><span data-prefix>₹</span><span><?php echo ($type_of_bed*$days); ?></span></td>
					</tr>
					<tr>
						<td><span >Advance</span></td>
						<td><span >-</span></td>
						<td><span data-prefix>₹</span><span ><?php  echo $advance;?></span></td>
						<!-- <td><span >-</span></td> -->
						<td><span data-prefix>₹</span><span><?php echo $advance; ?></span></td>
					</tr>
					<!-- <tr>
			...
			<table class="balance">
				<tr>
					...
					<td><span data-prefix>₹</span><span><?php if($old==0) echo ($fintot);
							  else echo ($fintot+$advance); ?></span></td>
				</tr>
				<tr>
					<th><span >Previous Amt</span></th>
					<td><span data-prefix>- ₹</span><span>
						<?php if($old==0) echo ($old);
							  else echo ($old+$advance); ?></span></td>
				</tr>
				<tr>
					<th><span >Amount to be Paid</span></th>
					<td><span data-prefix>₹</span><span ><?php echo ($fintot-$old); ?></span></td>
				</tr>
				<!-- <tr>
				...
				<tr>
					<th><span >Advance to be Returned</span></th>
					<td><span data-prefix>₹</span><span><?php echo $advance; ?></span></td>
				</tr>
			</table>
		</article>
